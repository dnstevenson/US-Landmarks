...
- (void)viewDidLoad {
	self.title = @"Favorites"; //[state name];
//	UIBarButtonItem *mapLandmarks = [[[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"location_white.png"] style:UIBarButtonItemStyleBordered
//																				target: self
